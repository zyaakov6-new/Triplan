...
const STRINGS = {
  he: {
    ...
    noPhotosSub: 'העלו תמונות מכל יום כדי לבנות אלבום של הטיול',
    ...
    fillBoth: 'מלאו את שני השדות כדי לחשב',
    tripStats: 'נתוני הטיול',
    days: 'ימים', stops: 'עצירות', done: 'בוצעו', totalBudget: 'תקציב כולל', avgDay: 'ממוצע ליום', cities: 'ערים', total: 'סה״כ',
    today: 'הטיול מתחיל היום!',
    inDays: (n) => n === 1 ? 'נשאר יום אחד' : n === 2 ? 'נשארו יומיים' : `נשארו ${n} ימים`,
    accessDenied: 'אין הרשאה',
    notMember: 'אינכם חברים בטיול הזה. בקשו קישור הזמנה מהמארגן.',
    ...
    inviteSub: 'כל מי שיש לו את הקישור יכול לצפות בטיול ולערוך אותו.',
    copy: 'העתקה', copied: 'הועתק!',
    readonlyShare: 'קישור לצפייה בלבד',
    readonlySub: 'שתפו גרסה לצפייה בלבד. לא נדרשת הרשמה.',
...
export default function TripDetailPage() {
  ...
  const countdown = useMemo(() => {
    ...
    return isHe ? t.inDays(diff) : `${diff} day${diff !== 1 ? 's' : ''} to go`
  }, [trip, t, isHe])
